...
- All .ui files under the DataSystemProject_prototype folder are UI prototype generated using Qt Designer app. These files are not required to run the prototype.
